...
class oakd_ros_class{
  public:
    ...
    int rgb_width, rgb_height;//add
    string StereoResolution;//add
    ...
    oakd_ros_class(ros::NodeHandle& n) : nh(n){
      ...
      nh.param("/rgb_width", rgb_width, 640);//add
      nh.param("/rgb_height", rgb_height, 480);//add
      nh.param<std::string>("/StereoResolution", StereoResolution, "THE_400_P");//add
...
//1st..........................................................................................................1st
  if(get_rgb && get_YOLO && get_stereo_ir && get_stereo_depth && get_pointcloud){
      //****** get_rgb ******//
      ...
      camRgb->setPreviewSize(rgb_width, rgb_height);//add 640,480
      ...
      if(StereoResolution == "THE_400_P"){
          monoLeft->setResolution(dai::MonoCameraProperties::SensorResolution::THE_400_P);
          monoRight->setResolution(dai::MonoCameraProperties::SensorResolution::THE_400_P);
      }else if(StereoResolution == "THE_480_P"){
          monoLeft->setResolution(dai::MonoCameraProperties::SensorResolution::THE_480_P);
          monoRight->setResolution(dai::MonoCameraProperties::SensorResolution::THE_480_P);
      }else if(StereoResolution == "THE_720_P"){
          monoLeft->setResolution(dai::MonoCameraProperties::SensorResolution::THE_720_P);
          monoRight->setResolution(dai::MonoCameraProperties::SensorResolution::THE_720_P);
      }else if(StereoResolution == "THE_800_P"){
...
//2ed..........................................................................................................2ed
    if(get_rgb && get_YOLO && get_stereo_ir && get_stereo_depth && !get_pointcloud){
        ...
        //****** get_stereo_depth,get_pointcloud ******//
        std::shared_ptr<dai::node::StereoDepth> stereodepth = pipeline.create<dai::node::StereoDepth>();
        std::shared_ptr<dai::node::XLinkOut> xoutDepth      = pipeline.create<dai::node::XLinkOut>();
        xoutDepth->setStreamName("depth");
        stereodepth->initialConfig.setConfidenceThreshold(depth_confidence);
...
//5th..........................................................................................................5th
    if(get_rgb && get_YOLO && !get_stereo_ir && get_stereo_depth && get_pointcloud){
        ...
        //****** get_stereo_ir,get_stereo_depth,get_pointcloud ******//
        std::shared_ptr<dai::node::MonoCamera> monoLeft     = pipeline.create<dai::node::MonoCamera>();
        std::shared_ptr<dai::node::MonoCamera> monoRight    = pipeline.create<dai::node::MonoCamera>();
        std::shared_ptr<dai::node::StereoDepth> stereodepth = pipeline.create<dai::node::StereoDepth>();
        std::shared_ptr<dai::node::XLinkOut> xoutDepth      = pipeline.create<dai::node::XLinkOut>();
...
//8th..........................................................................................................8th
    if(get_rgb && get_YOLO && !get_stereo_ir && !get_stereo_depth && !get_pointcloud){
        //****** get_rgb ******//
        std::shared_ptr<dai::node::ColorCamera> camRgb = pipeline.create<dai::node::ColorCamera>();//device terminal set data source.
        std::shared_ptr<dai::node::XLinkOut> xoutRgb = pipeline.create<dai::node::XLinkOut>();//device terminal set data output object.
        xoutRgb->setStreamName("rgb");//device terminal set data name.
        camRgb->setBoardSocket(dai::CameraBoardSocket::RGB);//device terminal set data properties.
        camRgb->setResolution(dai::ColorCameraProperties::SensorResolution::THE_1080_P);//device terminal set data properties.
        camRgb->setColorOrder(dai::ColorCameraProperties::ColorOrder::BGR);//device terminal set data properties.
        camRgb->setFps(fps_rgb_yolo);//device terminal set data properties.
        camRgb->setPreviewSize(rgb_width, rgb_height);//device terminal set data properties.
        camRgb->setInterleaved(false);//device terminal set data properties.
        camRgb->preview.link(xoutRgb->input);//device terminal set data output to show in host terminal.

        //****** get_YOLO ******//
        std::shared_ptr<dai::node::ImageManip> Manipulator  = pipeline.create<dai::node::ImageManip>();
        std::shared_ptr<dai::node::YoloDetectionNetwork> detectionNetwork = pipeline.create<dai::node::YoloDetectionNetwork>();
        std::shared_ptr<dai::node::XLinkOut> xoutInference  = pipeline.create<dai::node::XLinkOut>();//device terminal set data output object1.
        std::shared_ptr<dai::node::XLinkOut> nnOut = pipeline.create<dai::node::XLinkOut>();//device terminal set data output object2.
        nnOut->setStreamName("detections");//device terminal set 1st data name.
        xoutInference->setStreamName("detected_img");//device terminal set 2ed data name.
        camRgb->preview.link(Manipulator->inputImage);//device terminal set data output to show in host terminal.
        Manipulator->initialConfig.setResizeThumbnail(infer_img_width, infer_img_height);
        Manipulator->initialConfig.setFrameType(dai::ImgFrame::Type::BGR888p);
        Manipulator->inputImage.setBlocking(false);
        Manipulator->out.link(xoutInference->input);
...
//18ed..........................................................................................................18ed
    if(!get_rgb && get_YOLO && get_stereo_ir && get_stereo_depth && !get_pointcloud){
        ...
        xoutRgb->setStreamName("rgb");
        camRgb->setBoardSocket(dai::CameraBoardSocket::RGB);
        camRgb->setResolution(dai::ColorCameraProperties::SensorResolution::THE_1080_P);//add rgb information for pcl;
        camRgb->setColorOrder(dai::ColorCameraProperties::ColorOrder::BGR);
        camRgb->setFps(fps_rgb_yolo);
        camRgb->setInterleaved(false);
        camRgb->preview.link(xoutRgb->input);
